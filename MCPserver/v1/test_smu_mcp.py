...
def run_test():
    print("--- Starting SMU MCP Verification Test ---")
    ...
    # 1. Connect (Mock Mode for verification)
    print("\n[Step 1] Connecting (Mock Mode)...")
    resp_str = connect.fn(address="GPIB0::24::INSTR", mock=True)
    ...
    for i in range(1, 11):
        ...
        if data["status"] == "success":
            ...
            print(f"[{i}s] Measured: {v:.3f} V, {i_meas:.4e} A")
        else:
